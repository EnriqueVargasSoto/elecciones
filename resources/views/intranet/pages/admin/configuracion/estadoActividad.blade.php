                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="/api/estadoActividad" id="createForm">
...
@section('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#color_ic").on("keyup", function(e) {
                let value = e.target.value;
                if (!value) {
                    $("#color_ic").addClass("is-invalid");
                    $("#invalidColorCreate").html("El color es requerido");
                } else {
                    $("#color_ic").removeClass("is-invalid");
                    $("#invalidColorCreate").html("");
                }
            });
            $("#color_ie").on("keyup", function(e) {
                let value = e.target.value;
                if (!value) {
                    $("#color_ie").addClass("is-invalid");
                    $("#invalidColorEdit").html("El color es requerido");
                } else {
                    $("#color_ie").removeClass("is-invalid");
                    $("#invalidColorEdit").html("");
                }
            });
            ...
            $("#editForm").on("submit", function(e) {
                ...
                if (validateFormEdit(objtValues)) {
                    $.ajax({
                        url: `/api/estadoActividad/${objtValues.id}`,
                        type: "PUT",
                        data: objtValues,
                        headers: {
                            "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr(
        ...
        const handleDelete = function(ev) {
            ...
            if (confirmDelete) {
                $.ajax({
                    url: `/api/estadoActividad/${$(ev).attr("objectid")}`,
                    type: "DELETE",
                    headers: {
                        "X-CSRF-TOKEN": $('meta[name="csrf-token"]').attr(
                            "content"
