              ...
              <tbody>
                @foreach ($candidatos as $key => $candidato)
                    <tr>
                      ...
                      <td class="text-sm font-weight-normal">{{$candidato->nombre_apellido}}</td>
                      <td class="text-sm font-weight-normal">{{$candidato->tipo}}</td>
                      <td class="text-sm font-weight-normal">{{$candidato->provincia_id}}</td>
                      <td class="text-sm font-weight-normal">{{$candidato->distrito_id}}</td>
                      <td class="text-sm font-weight-normal">{{$candidato->partido}}</td>
                      <td class="text-sm font-weight-normal">{{$candidato->observador}}</td>
                    </td>
                      <!-- <td class="text-sm font-weight-normal">{{$candidato->provincia}}</td> -->
                    </tr>
                @endforeach
              </tbody>
            </table>
